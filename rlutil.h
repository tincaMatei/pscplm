...
const RLUTIL_STRING_T ANSI_BACKGROUND_BROWN        = "\033[48;5;3m";
...
const RLUTIL_STRING_T ANSI_BACKGROUND_GREY         = "\033[48;5;249m";
const RLUTIL_STRING_T ANSI_BACKGROUND_LIGHTMAGENTA = "\033[48;5;200m";
const RLUTIL_STRING_T ANSI_BACKGROUND_WHITE        = "\033[48;5;15m";
const RLUTIL_STRING_T ANSI_BACKGROUND_YELLOW       = "\033[48;5;11m";
const RLUTIL_STRING_T ANSI_BACKGROUND_LIGHTCYAN    = "\033[48;5;14m";
...
RLUTIL_INLINE RLUTIL_STRING_T getANSIBackgroundColor(const int c) {
	switch (c) {
		...
		case WHITE        : return ANSI_BACKGROUND_WHITE;
		case LIGHTMAGENTA : return ANSI_BACKGROUND_LIGHTMAGENTA;
		case YELLOW       : return ANSI_BACKGROUND_YELLOW;
		case LIGHTCYAN    : return ANSI_BACKGROUND_LIGHTCYAN;
		default: return "";
	}
}
